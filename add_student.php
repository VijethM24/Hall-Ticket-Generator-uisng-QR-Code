                            ...
                            <div class="card-body">
                                <div class="input-states">
                                   ...
                                   <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                <label class="col-sm-3 control-label">Sem</label>
                                                <div class="col-sm-9">
                                                    <input type="text" name="tbSem" class="form-control" placeholder="Parents Contact Number" id="tbSem"  onkeypress="javascript:return isNumber(event)" required="">
                                                </div>
                                            </div>
                                        </div>
